...
The original validation used 999 real-world, proprietary tests. Because those source data cannot be shared, this repository includes a randomized 10-test example dataset.

Users may run these scripts with their own appropriately formatted OGTT/MTT data and corresponding AOMM output to reproduce the included validation checks.
